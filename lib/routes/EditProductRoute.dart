          ...
          child: ListView(
            children: <Widget>[
              TextFormField(
                ...
                validator: (value){
                 return (value.trim().isEmpty ) ? 'Please provide a value' : null;
                },
                onSaved: (value){
                  _editedProduct = Product(
                      title: value,
              ...
              TextFormField(
                ...
                validator: (value){
                  return (value.isEmpty )
                      ? 'Please enter a valid number' : (double.tryParse(value) == null)
                      ? 'Please enter a valid number' : (double.parse(value)<=0)
                      ? 'Please enter a number greater than zero': null;
                },
                onSaved: (value){
                  _editedProduct = Product(
                      title: _editedProduct.title,
              ...
              TextFormField(
                ...
                validator: (value){
                  return (value.trim().isEmpty )
                      ? 'Please provide a description' : (value.trim().length < 10 )? 'Minimum of 10 characters' : null;
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      validator: (value){
                        return (value.trim().isEmpty )
                            ? 'Please provide an image url' : (!value.startsWith('http') || !value.startsWith('https'))
